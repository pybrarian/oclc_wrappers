...
class TestUrls(TestCase):
    ...
    def setUp(self):
        self.many_url = MultipleUrls(ITEM_URLS)
        self.single_url = SingleUrl(CLASSIFY_URL)

    def test_get_url_from_a_multiple(self):
        self.assertEqual('https://acq.sd00.worldcat.org/purchaseorders/PO-123/items',
                         self.many_url.get_url('create', order='PO-123'))
